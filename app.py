...
with st.sidebar:
    ...
    st.code("1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa")  # Satoshi (nunca usada)
    st.code("1BoatSLRHtKNngkdXEeobR76b53LETtpyT")    # Activa
    st.code("bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdq")  # Inactiva
